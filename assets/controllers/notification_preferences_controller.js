...
/**
 * Stimulus controller for notification preferences management (FR67).
 *
 * Handles AJAX saves when preferences are toggled.
 *
 * Usage:
 * <div data-controller="notification-preferences"
 *      data-notification-preferences-csrf-value="token">
 *     <input type="checkbox"
 *            data-notification-preferences-target="checkbox"
 *            data-action="change->notification-preferences#toggle"
 *            data-key="d_minus_1">
 *     <div data-notification-preferences-target="toast">Saved</div>
 * </div>
 */
